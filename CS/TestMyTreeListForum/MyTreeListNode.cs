...
namespace DevExpress.MyControl
{
    ...
    public class MyTreeListNode : TreeListNode
    {
        ...
        internal void CalcAvatarBounds(Rectangle rect)
        {
            ...
            avatarCaptionBounds = new Rectangle(new Point((rect.Width - AVATARCaptionWidth) / 2 + rect.X, avatarImageBounds.Bottom + 2), new Size(AVATARCaptionWidth, rect.Bottom - avatarImageBounds.Bottom - 4));
        }
