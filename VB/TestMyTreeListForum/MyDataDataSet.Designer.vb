...
Namespace TestMyTreeListForum.MyDataDataSetTableAdapters
	...
	Partial Public Class CustomersTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Customers` WHERE ((`ID` = ?) AND ((? = 1 AND `FirstName` IS NULL) OR" &
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Customers` SET `FirstName` = ?, `Description` = ?, `ParentID` = ?, `Avata" &
				"r` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `FirstName` IS NULL) OR (`FirstName` = " &
