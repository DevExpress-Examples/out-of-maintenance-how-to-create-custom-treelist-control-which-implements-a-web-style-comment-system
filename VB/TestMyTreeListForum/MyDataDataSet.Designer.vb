...
Namespace TestMyTreeListForum
    ...
    Partial Public Class MyDataDataSet
        ...
        Partial Public Class CustomersDataTable
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
            Public Function AddCustomersRow(ByVal FirstName As String, ByVal Description As String, ByVal ParentID As Integer, ByVal Avatar() As Byte) As CustomersRow
                Dim rowCustomersRow As CustomersRow = (CType(Me.NewRow(), CustomersRow))
                Dim columnValuesArray() As Object = { Nothing, FirstName, Description, ParentID, Avatar}
        ...
        Partial Public Class CustomersRow
            ...
            Public Property Description() As String
                Get
                    Try
                        Return (CStr(Me(Me.tableCustomers.DescriptionColumn)))
                    Catch e As Global.System.InvalidCastException
            ...
            Public Property ParentID() As Integer
                Get
                    Try
                        Return (CInt((Me(Me.tableCustomers.ParentIDColumn))))
                    Catch e As Global.System.InvalidCastException
    ...
    End Class
End Namespace
Namespace TestMyTreeListForum.MyDataDataSetTableAdapters
    ...
    Partial Public Class CustomersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Customers` WHERE ((`ID` = ?) AND ((? = 1 AND `FirstName` IS NULL) OR" & " (`FirstName` = ?)) AND ((? = 1 AND `ParentID` IS NULL) OR (`ParentID` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Customers` (`FirstName`, `Description`, `ParentID`, `Avatar`) VALUES" & " (?, ?, ?, ?)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Avatar", Global.System.Data.OleDb.OleDbType.LongVarBinary, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "Avatar", Global.System.Data.DataRowVersion.Current, False, Nothing))
            Me._adapter.UpdateCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Customers` SET `FirstName` = ?, `Description` = ?, `ParentID` = ?, `Avata" & "r` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `FirstName` IS NULL) OR (`FirstName` = " & "?)) AND ((? = 1 AND `ParentID` IS NULL) OR (`ParentID` = ?)))"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Avatar", Global.System.Data.OleDb.OleDbType.LongVarBinary, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "Avatar", Global.System.Data.DataRowVersion.Current, False, Nothing))
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = My.Settings.Default.MyDataConnectionString
        End Sub
        ...
        Public Overridable Function Fill(ByVal dataTable As MyDataDataSet.CustomersDataTable) As Integer
        ...
        Public Overridable Function GetData() As MyDataDataSet.CustomersDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As New MyDataDataSet.CustomersDataTable()
        ...
        Public Overridable Function Update(ByVal dataTable As MyDataDataSet.CustomersDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function

        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")> _
        Public Overridable Function Update(ByVal dataSet As MyDataDataSet) As Integer
        ...
        Public Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_FirstName As String, ByVal Original_ParentID? As Integer) As Integer
            ...
            If (Original_ParentID.HasValue = True) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(4).Value = (CInt(Original_ParentID.Value))
            Else
        ...
        Public Overridable Function Insert(ByVal FirstName As String, ByVal Description As String, ByVal ParentID? As Integer, ByVal Avatar() As Byte) As Integer
            ...
            If (ParentID.HasValue = True) Then
                Me.Adapter.InsertCommand.Parameters(2).Value = (CInt(ParentID.Value))
            Else
        ...
        Public Overridable Function Update(ByVal FirstName As String, ByVal Description As String, ByVal ParentID? As Integer, ByVal Avatar() As Byte, ByVal Original_ID As Integer, ByVal Original_FirstName As String, ByVal Original_ParentID? As Integer) As Integer
            If (FirstName Is Nothing) Then
            ...
            End If
            If (ParentID.HasValue = True) Then
                Me.Adapter.UpdateCommand.Parameters(2).Value = (CInt(ParentID.Value))
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(6).Value = (CStr(Original_FirstName))
            End If
            If (Original_ParentID.HasValue = True) Then
                Me.Adapter.UpdateCommand.Parameters(7).Value = (CObj(0))
                Me.Adapter.UpdateCommand.Parameters(8).Value = (CInt(Original_ParentID.Value))
            Else
