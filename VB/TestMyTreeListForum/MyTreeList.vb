...
Namespace DevExpress.MyControl
	Public Class MyTreeList
        ...
        Private avatarCaptionFieldNameField As String
        Private avatarImageFieldNameField As String
        ...
        Public Sub New()
            ...
            Me.avatarCaptionFieldNameField = String.Empty
            Me.avatarImageFieldNameField = String.Empty
        End Sub
        ...
        Public Property AvatarCaptionFieldName() As String
            Get
                Return avatarCaptionFieldNameField
            End Get
            Set(ByVal value As String)
                If avatarCaptionFieldNameField = value Then
                    Return
                End If
                ...
                avatarCaptionFieldNameField = value
            End Set
        End Property
        ...
        Public Property AvatarImageFieldName() As String
            Get
                Return avatarImageFieldNameField
            End Get
            Set(ByVal value As String)
                If avatarImageFieldNameField = value Then
                    Return
                End If
                If value <> String.Empty Then
                    Dim tlc As TreeListColumn = Columns(value)
                ...
                avatarImageFieldNameField = value
            End Set
		End Property
