...
Namespace DevExpress.MyControl
	...
	Public Class MyTreeListNode
		...
		Friend Sub CalcAvatarBounds(ByVal rect As Rectangle)
			...
			avatarCaptionBounds_Renamed = New Rectangle(New Point((rect.Width - AVATARCaptionWidth) / 2 + rect.X, avatarImageBounds_Renamed.Bottom + 2), New Size(AVATARCaptionWidth, rect.Bottom - avatarImageBounds_Renamed.Bottom - 4))
		End Sub
		...
		Protected Overridable Function GetImage() As Image
			...
			Try
                Dim col As TreeListColumn = TreeList.Columns(mtl.AvatarImageFieldName)
